...
namespace Eventures.App.Areas.Identity.Pages.Account
{
    ...
    {
        private const string InvalidUCNMessage = "The {0} should consist of exactly 10 numeric characters";
        ...
        public class InputModel
        {
            ...
            [Required]
            [RegularExpression("^[0-9]{10}$", ErrorMessage = InvalidUCNMessage)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new EventuresUser
                {
                    ...
                    UniqueCitizenNumber = Input.UniversalCitizenNumber
                };
